...
class UiAndStorageTests(unittest.TestCase):
    def test_marketing_console_contains_end_user_forms(self):
        ...
        self.assertIn("Trend Studio", html)
        self.assertIn("Plan better Reels faster", html)
        self.assertIn("Find Trends", html)
        self.assertIn("Create Ideas", html)
        ...
        self.assertIn("/workflows/trend-research", html)
        self.assertIn("/workflows/reel-concepts", html)
